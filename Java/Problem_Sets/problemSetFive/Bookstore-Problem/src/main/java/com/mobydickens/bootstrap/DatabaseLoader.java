...
public class DatabaseLoader implements ApplicationListener<ContextRefreshedEvent>
{
    ...
    {
        // Create Books
        Book b1 = new Book(1, 5, 25, 2011, "Fifty Shades of Grey", "E. L. James", 345803485, Genre.ROMANCE, 19.99);
        bookRepository.addBook(b1);

        Book b2 = new Book(2, 4, 18, 2000, "Dracula", "Bram Stoker", 486454010, Genre.HORROR, 10.99);
        bookRepository.addBook(b2);

        Book b3 = new Book(3, 3, 1, 1981, "Moby-Dick", "Herman Melville", 553213113, Genre.CLASSICS, 19.99);
        bookRepository.addBook(b3);

        Book b4 = new Book(4, 7, 1, 1992, "Learning Java", "James O'Reilly", 596002858, Genre.NONFICTION, 44.99);
        bookRepository.addBook(b4);


        // Add users
        ApplicationUser admin = new ApplicationUser(1, "admin", "123456", Boolean.TRUE);
        applicationUserRepository.createApplicationUser(admin);

        ApplicationUser norm = new ApplicationUser(2, "norm", "654321", Boolean.FALSE);
